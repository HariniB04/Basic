...
public class Stringpass{
    ...
    public static void createPassword(String word1, String word2) {
        ...
        String password = w1[1] + w2[2] + w1[0] + w2[0];
        ...
        System.out.println("So, Password = Second part of word1 + Third part of word2 + First part of word1 + First part of word2");
        System.out.println("= " + w1[1] + " + " + w2[2] + " + " + w1[0] + " + " + w2[0]);
