...
public class Model4 {
    ...
    public static void createPassword(String word1, String word2) {
        ...
        System.out.println("So, Password = Third part of word2 + Second part of word1 + Second part of word2 + First part of word1");
        System.out.println("= " + w2[2] + " + " + w1[1] + " + " + w2[1] + " + " + w1[0]);
